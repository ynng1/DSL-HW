...
HD_PWD='C:/Users/User/DSL/DSL HW1/DSL HW1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nor_rs_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nor_rs_tb.tcl -notrace
