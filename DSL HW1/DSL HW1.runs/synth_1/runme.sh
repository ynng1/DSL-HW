...
HD_PWD='C:/Users/User/DSL/DSL HW1/DSL HW1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nor_rs_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nor_rs_tb.tcl
